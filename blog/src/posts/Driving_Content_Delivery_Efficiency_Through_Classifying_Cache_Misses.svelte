<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2025-07-19',
    categories: ["Backend"],
    coverImage: '/images/Driving_Content_Delivery_Efficiency_Through_Classifying_Cache_Misses/e4003e96ff8993d6.png',
    coverWidth: 16,
    coverHeight: 9,
...
<img src="/images/Driving_Content_Delivery_Efficiency_Through_Classifying_Cache_Misses/e4003e96ff8993d6.png" alt="" class="responsive-image" />
...
<li>OCA 상태와 상관 없이, 각 클라이언트 기준으로 최적의 OCA에서 데이터가 제공되지 않을 때
  ...
  <li>IP의 근접성 기준으로 결정 (BGP 경로..?)
    <details>
      ...
      <img src="/images/Driving_Content_Delivery_Efficiency_Through_Classifying_Cache_Misses/1395088143d922d1.png" alt="" class="responsive-image" />
...
<img src="/images/Driving_Content_Delivery_Efficiency_Through_Classifying_Cache_Misses/646113d2f15a0557.png" alt="" class="responsive-image" />
...
<img src="/images/Driving_Content_Delivery_Efficiency_Through_Classifying_Cache_Misses/516d864712c44b01.png" alt="" class="responsive-image" />
