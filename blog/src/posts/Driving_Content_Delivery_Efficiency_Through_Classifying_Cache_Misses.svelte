<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2025-07-19',
    categories: ["Backend"],
    coverImage: '/images/Driving_Content_Delivery_Efficiency_Through_Classifying_Cache_Misses/5f861c1379440b53.png',
    coverWidth: 16,
    coverHeight: 9,
...
<img src="/images/Driving_Content_Delivery_Efficiency_Through_Classifying_Cache_Misses/5f861c1379440b53.png" alt="" class="responsive-image" />
...
<li>OCA 상태와 상관 없이, 각 클라이언트 기준으로 최적의 OCA에서 데이터가 제공되지 않을 때
  ...
  <li>IP의 근접성 기준으로 결정 (BGP 경로..?)
    <details>
      ...
      <img src="/images/Driving_Content_Delivery_Efficiency_Through_Classifying_Cache_Misses/8f5cd0f6f59927be.png" alt="" class="responsive-image" />
...
<img src="/images/Driving_Content_Delivery_Efficiency_Through_Classifying_Cache_Misses/baf52afe87700539.png" alt="" class="responsive-image" />
...
<img src="/images/Driving_Content_Delivery_Efficiency_Through_Classifying_Cache_Misses/13d7e74a70d14a3e.png" alt="" class="responsive-image" />
