<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2025-07-19',
    categories: ["Backend"],
    coverImage: '/images/Driving_Content_Delivery_Efficiency_Through_Classifying_Cache_Misses/dc3e4cee71a71ee7.png',
    coverWidth: 16,
    coverHeight: 9,
...
<img src="/images/Driving_Content_Delivery_Efficiency_Through_Classifying_Cache_Misses/dc3e4cee71a71ee7.png" alt="" class="responsive-image" />
...
<li>OCA 상태와 상관 없이, 각 클라이언트 기준으로 최적의 OCA에서 데이터가 제공되지 않을 때
  ...
  <li>IP의 근접성 기준으로 결정 (BGP 경로..?)
    <details>
      ...
      <img src="/images/Driving_Content_Delivery_Efficiency_Through_Classifying_Cache_Misses/9223a3688ef27ba3.png" alt="" class="responsive-image" />
...
<img src="/images/Driving_Content_Delivery_Efficiency_Through_Classifying_Cache_Misses/6e35da2d329d0b0a.png" alt="" class="responsive-image" />
...
<img src="/images/Driving_Content_Delivery_Efficiency_Through_Classifying_Cache_Misses/ea26a9fd229431e0.png" alt="" class="responsive-image" />
