<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2025-04-16',
    categories: ["Backend"],
    coverImage: '/images/Distributed_Counter/cbe34c3335029cfc.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/Distributed_Counter/cbe34c3335029cfc.png" alt="" class="responsive-image" />
...
<img src="/images/Distributed_Counter/d85c47e45e1eaf1f.png" alt="" class="responsive-image" />
...
<details>
  ...
  <details>
    ...
    <img src="/images/Distributed_Counter/399e1173468f4435.png" alt="" class="responsive-image" />
...
<li>Approach 1: Storing a Single Row per Counter
  <img src="/images/Distributed_Counter/b56b3f451810fd1a.png" alt="" class="responsive-image" />
...
<li>Approach 2: Per Instance Aggregation
  ...
  <img src="/images/Distributed_Counter/8e51d45e3845787d.png" alt="" class="responsive-image" />
...
<li>Approach 3: Using Durable Queues
  ...
  <img src="/images/Distributed_Counter/267e363d99214663.png" alt="" class="responsive-image" />
...
<li>Approach 4: Event Log of Individual Increments
  ...
  <img src="/images/Distributed_Counter/49f477be8e45af09.png" alt="" class="responsive-image" />
...
<li>Aggregating Count Events
  <img src="/images/Distributed_Counter/21d5bdb35f0e272c.png" alt="" class="responsive-image" />
...
<li>Rollup Store
  <img src="/images/Distributed_Counter/12338c38c798083d.png" alt="" class="responsive-image" />
...
<li>Rollup Cache
  <img src="/images/Distributed_Counter/00ff1db9d474ccd0.png" alt="" class="responsive-image" />
...
<ul>
<li>Rollup Pipeline
  <img src="/images/Distributed_Counter/715fb16ec61576b4.png" alt="" class="responsive-image" />

  <img src="/images/Distributed_Counter/436539fad6f3b2cc.png" alt="" class="responsive-image" />
