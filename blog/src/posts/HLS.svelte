<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/ad6a9d1b0ea3bf6e.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/ad6a9d1b0ea3bf6e.png" alt="" class="responsive-image" />

<img src="/images/HLS/4dfee6f7da5cd862.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/2d41723b3bffaa03.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/d55fe6a40e4e3868.png" alt="" class="responsive-image" />
