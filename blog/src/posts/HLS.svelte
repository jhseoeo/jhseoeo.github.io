<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/9d189448760a206e.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/9d189448760a206e.png" alt="" class="responsive-image" />

<img src="/images/HLS/fb29da07a301a75e.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/f46a8114bcca0e93.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/042753a4481024e0.png" alt="" class="responsive-image" />
