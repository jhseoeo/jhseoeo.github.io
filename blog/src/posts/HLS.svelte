<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/f6fc20a62ed6a649.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/f6fc20a62ed6a649.png" alt="" class="responsive-image" />

<img src="/images/HLS/792ffb53f74d5f1e.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/4bd7a4db1c1caaf1.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/ef1999dfcb866263.png" alt="" class="responsive-image" />
