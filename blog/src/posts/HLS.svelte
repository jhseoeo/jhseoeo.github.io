<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/a52b31a1b76e0fe0.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/a52b31a1b76e0fe0.png" alt="" class="responsive-image" />

<img src="/images/HLS/1be777cf98f9b7d4.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/468704081019083b.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/63f03a58158e965c.png" alt="" class="responsive-image" />
