<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/15ddb31969c1c8d9.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/15ddb31969c1c8d9.png" alt="" class="responsive-image" />

<img src="/images/HLS/49892b3e18aad610.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/7f87bdf91988d565.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/1625254e3d4e8067.png" alt="" class="responsive-image" />
