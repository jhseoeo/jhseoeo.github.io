<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2026-01-12',
    categories: ["Backend"],
    coverImage: '/images/HLS/2b969ee4268628a3.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/2b969ee4268628a3.png" alt="" class="responsive-image" />

<img src="/images/HLS/32046427e78f82b1.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/f5e34fc212ec29c0.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/a4859cd78ca1e01e.png" alt="" class="responsive-image" />
