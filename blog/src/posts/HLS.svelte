<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/5b40778a1239fbdb.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/5b40778a1239fbdb.png" alt="" class="responsive-image" />

<img src="/images/HLS/0ede16c3250de7ae.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/c7957a3c1bc275e4.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/84b236c8a53fbe79.png" alt="" class="responsive-image" />
