<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/9465f6ea7cf266e3.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/9465f6ea7cf266e3.png" alt="" class="responsive-image" />

<img src="/images/HLS/53d5f6853280dd09.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/67e570a5070ecce6.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/426899ccca323e5c.png" alt="" class="responsive-image" />
