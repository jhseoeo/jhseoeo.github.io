<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/a7ef8ebff5e02f65.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/a7ef8ebff5e02f65.png" alt="" class="responsive-image" />

<img src="/images/HLS/2c06ab2acef4a37a.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/55e8855705982f46.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/14ffc355161d1e09.png" alt="" class="responsive-image" />
