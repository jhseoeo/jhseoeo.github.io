<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/0a5b90c74208cfff.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/0a5b90c74208cfff.png" alt="" class="responsive-image" />

<img src="/images/HLS/0f02e0ccdcc0be04.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/971e1f16440fd6a1.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/653bf34068ea2ea1.png" alt="" class="responsive-image" />
