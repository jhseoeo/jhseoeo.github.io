<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/013403fc42cb19bc.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/013403fc42cb19bc.png" alt="" class="responsive-image" />

<img src="/images/HLS/4f2fefb2091596f5.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/edb8366c3be916de.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/6741ccf48915e90b.png" alt="" class="responsive-image" />
