<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/950802e510b9e04b.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/950802e510b9e04b.png" alt="" class="responsive-image" />

<img src="/images/HLS/9b6de238b47bb0c4.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/11db501343bcd9ba.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/7f11b670c30f3a92.png" alt="" class="responsive-image" />
