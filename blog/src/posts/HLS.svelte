<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/a3cfe233ffc362a9.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/a3cfe233ffc362a9.png" alt="" class="responsive-image" />

<img src="/images/HLS/7b6f06bd4bc0f428.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/2da4966a5e8e27c1.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/9bcf42d990aaaa65.png" alt="" class="responsive-image" />
