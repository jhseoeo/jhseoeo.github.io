<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/ad99ba1525e823dc.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/ad99ba1525e823dc.png" alt="" class="responsive-image" />

<img src="/images/HLS/a9c80c4b7bdcf92a.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/18a9583cf8ad7ddb.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/fbba9355ecb18750.png" alt="" class="responsive-image" />
