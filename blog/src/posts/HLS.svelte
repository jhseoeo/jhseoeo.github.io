<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/10af767cf88b709e.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/10af767cf88b709e.png" alt="" class="responsive-image" />

<img src="/images/HLS/434df8c2140ae449.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/ec8dbbfbfc4de4ab.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/b914951ef0f65646.png" alt="" class="responsive-image" />
