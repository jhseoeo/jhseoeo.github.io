<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/f0ee51aefefef668.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/f0ee51aefefef668.png" alt="" class="responsive-image" />

<img src="/images/HLS/881f8bad2f18e424.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/8b9f4b34aed74e4b.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/aba27d652a59b9b6.png" alt="" class="responsive-image" />
