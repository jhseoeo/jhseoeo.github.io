<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/9157de8a479fba7c.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/9157de8a479fba7c.png" alt="" class="responsive-image" />

<img src="/images/HLS/13fa835d9afa0331.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/e9b98a53bee7fd57.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/08bc963a50332625.png" alt="" class="responsive-image" />
