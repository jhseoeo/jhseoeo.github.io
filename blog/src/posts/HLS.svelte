<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/957d3b7f6f55a8f8.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/957d3b7f6f55a8f8.png" alt="" class="responsive-image" />

<img src="/images/HLS/e3e3775efa88e703.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/9c3fa8c7afba1c21.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/add45b3320993838.png" alt="" class="responsive-image" />
