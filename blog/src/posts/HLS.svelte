<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/fe939e09d00a497d.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/fe939e09d00a497d.png" alt="" class="responsive-image" />

<img src="/images/HLS/b901a59ff1b8a146.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/76c12b11aaa60210.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/c348cb9096de28af.png" alt="" class="responsive-image" />
