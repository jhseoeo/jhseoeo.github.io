<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/98caa303bf168e45.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/98caa303bf168e45.png" alt="" class="responsive-image" />

<img src="/images/HLS/da774a63001cc6b9.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/21cd2d319426f55d.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/303389eb49a9a6da.png" alt="" class="responsive-image" />
