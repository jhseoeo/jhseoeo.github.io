<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/fca0a913ece66e85.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/fca0a913ece66e85.png" alt="" class="responsive-image" />

<img src="/images/HLS/223f22a0b6d9dd32.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/f61c6964198f17f2.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/e1d50537c3653a70.png" alt="" class="responsive-image" />
