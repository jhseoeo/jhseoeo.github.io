<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/83009ec403a80fea.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/83009ec403a80fea.png" alt="" class="responsive-image" />

<img src="/images/HLS/83ada1467a94bc69.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/1be8a6a2d80b1da2.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/5be03add60ab9afc.png" alt="" class="responsive-image" />
