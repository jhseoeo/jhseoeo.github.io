<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/c86553427d25c0fa.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/c86553427d25c0fa.png" alt="" class="responsive-image" />

<img src="/images/HLS/62cb61238a6119b6.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/4d1a4b8f12b41157.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/7675533f62cda33a.png" alt="" class="responsive-image" />
