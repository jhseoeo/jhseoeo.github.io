<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/0518c98938ed4887.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/0518c98938ed4887.png" alt="" class="responsive-image" />

<img src="/images/HLS/ab888faca87b0364.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/4be42f3f1201a1fd.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/ea9afd1edb1eccae.png" alt="" class="responsive-image" />
