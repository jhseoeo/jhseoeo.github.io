<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/f400279dad30c695.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/f400279dad30c695.png" alt="" class="responsive-image" />

<img src="/images/HLS/dd3564c19d6f3fa9.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/cb9feb166e87c41f.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/17e25f0acb9680a7.png" alt="" class="responsive-image" />
