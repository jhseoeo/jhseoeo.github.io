<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/6b898fa4c39d5f12.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/6b898fa4c39d5f12.png" alt="" class="responsive-image" />

<img src="/images/HLS/34de85a1108e92e5.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/70d0db3cd8214459.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/0ec525c01468f55f.png" alt="" class="responsive-image" />
