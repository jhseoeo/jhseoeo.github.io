<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/4fa346ebaadf58fb.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/4fa346ebaadf58fb.png" alt="" class="responsive-image" />

<img src="/images/HLS/470a02ab2aee851b.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/3742df7d69aec10e.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/1adea3c40e4eee6e.png" alt="" class="responsive-image" />
