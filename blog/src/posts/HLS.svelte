<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/0ff6bba39acdff80.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/0ff6bba39acdff80.png" alt="" class="responsive-image" />

<img src="/images/HLS/2a643a03b45200a6.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/ca23199f44f8ebe3.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/49384c013a8a6c7c.png" alt="" class="responsive-image" />
