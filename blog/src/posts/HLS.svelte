<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/b2ceff5eee7fa016.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/b2ceff5eee7fa016.png" alt="" class="responsive-image" />

<img src="/images/HLS/289653a3453b6087.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/95517ee982a93eae.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/1f7e336f905c07b3.png" alt="" class="responsive-image" />
