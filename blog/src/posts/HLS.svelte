<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/5751720779b977da.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/5751720779b977da.png" alt="" class="responsive-image" />

<img src="/images/HLS/8cd0d78eb6aaa8b3.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/1417457439545119.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/457ea2fdbebd23dc.png" alt="" class="responsive-image" />
