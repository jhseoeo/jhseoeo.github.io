<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/deb0ceea8f5326ba.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/deb0ceea8f5326ba.png" alt="" class="responsive-image" />

<img src="/images/HLS/0236317428599302.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/cdf863a3bfd87aea.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/c1ac15f0e3847a14.png" alt="" class="responsive-image" />
