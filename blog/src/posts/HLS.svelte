<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/4a4a0a0082575768.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/4a4a0a0082575768.png" alt="" class="responsive-image" />

<img src="/images/HLS/0a66c7df02924740.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/cade8492e2508df9.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/73fd6c25220ff0e7.png" alt="" class="responsive-image" />
