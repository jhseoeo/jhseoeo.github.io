<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/46c435fade472359.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/46c435fade472359.png" alt="" class="responsive-image" />

<img src="/images/HLS/0a7d406f225667e6.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/6e6142dae931f63c.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/bfef1db763734420.png" alt="" class="responsive-image" />
