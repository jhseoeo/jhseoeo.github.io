<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/f214354ed9081e0e.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/f214354ed9081e0e.png" alt="" class="responsive-image" />

<img src="/images/HLS/dad1049f63fc3234.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/d66e0b6184f41d86.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/0380cf0bbb701b27.png" alt="" class="responsive-image" />
