<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/3ebc8d98656be05d.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/3ebc8d98656be05d.png" alt="" class="responsive-image" />

<img src="/images/HLS/689edbf6f6427d75.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/9a41b213d7273e9e.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/8b57095e0e1a782a.png" alt="" class="responsive-image" />
