<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/cef73c91021ceaeb.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/cef73c91021ceaeb.png" alt="" class="responsive-image" />

<img src="/images/HLS/70c6d13c18f938a7.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/e1fbd5c6d43bf9d8.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/0d6f419e2039f840.png" alt="" class="responsive-image" />
