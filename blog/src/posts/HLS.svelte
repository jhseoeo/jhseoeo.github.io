<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/99ce4358c738481d.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/99ce4358c738481d.png" alt="" class="responsive-image" />

<img src="/images/HLS/64a2f659bbb6f5d1.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/d045d64eb3cc4bc0.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/a27e4970615924b1.png" alt="" class="responsive-image" />
