<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/950763f2d6bef8eb.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/950763f2d6bef8eb.png" alt="" class="responsive-image" />

<img src="/images/HLS/cb28a456ec483f95.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/c214ace400a8cd26.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/64aa36470e573ac0.png" alt="" class="responsive-image" />
