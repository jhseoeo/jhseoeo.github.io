<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/fa52090eb3201653.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/fa52090eb3201653.png" alt="" class="responsive-image" />

<img src="/images/HLS/de8cf0e9499cd613.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/79a9e9a61a6b2b1e.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/b6d01a5129abe9b2.png" alt="" class="responsive-image" />
