<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/a469e713381dcc47.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/a469e713381dcc47.png" alt="" class="responsive-image" />

<img src="/images/HLS/eef2512ed8b83c2b.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/66fa73ee514b2653.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/8fe18a1203d13b1c.png" alt="" class="responsive-image" />
