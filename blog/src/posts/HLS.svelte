<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/33b037657c3add3e.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/33b037657c3add3e.png" alt="" class="responsive-image" />

<img src="/images/HLS/41256eeda542e4bd.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/e5711c96512bcaba.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/5ddae7f2752d653b.png" alt="" class="responsive-image" />
