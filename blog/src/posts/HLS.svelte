<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/3a703b558be82116.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/3a703b558be82116.png" alt="" class="responsive-image" />

<img src="/images/HLS/a4124e20a3311c2d.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/cef58d9e5b1de9f6.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/affb13e140f6d941.png" alt="" class="responsive-image" />
