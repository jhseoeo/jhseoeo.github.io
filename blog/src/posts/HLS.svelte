<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/58259ff830711e5e.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/58259ff830711e5e.png" alt="" class="responsive-image" />

<img src="/images/HLS/e761fc4f22f71fc3.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/acd7ca534835f138.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/c5c9dc2ec775acd6.png" alt="" class="responsive-image" />
