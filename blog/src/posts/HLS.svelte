<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/de69b144a0d50b28.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/de69b144a0d50b28.png" alt="" class="responsive-image" />

<img src="/images/HLS/b91eb918e793b460.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/a5d57d2304004a06.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/d24f2137f4cb6123.png" alt="" class="responsive-image" />
