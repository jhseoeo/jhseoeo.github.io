<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/cf76729f7cbbc605.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/cf76729f7cbbc605.png" alt="" class="responsive-image" />

<img src="/images/HLS/dc4a921086f36d47.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/ee817b47f2ee2ab4.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/f86dc9247b1cd11a.png" alt="" class="responsive-image" />
