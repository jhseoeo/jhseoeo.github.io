<script context="module" lang="ts">
  export const metadata = {
    ...
    date: '2024-09-30',
    categories: ["Backend"],
    coverImage: '/images/HLS/111a4b239d84025b.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<img src="/images/HLS/111a4b239d84025b.png" alt="" class="responsive-image" />

<img src="/images/HLS/1fe2864a50e1fca2.png" alt="" class="responsive-image" />

<p>Content-Type: application/vnd.apple.mpegurl</p>

<p>request body에 m3u8이 왔다</p>

<img src="/images/HLS/fc84ece7b593a068.png" alt="" class="responsive-image" />
...
<img src="/images/HLS/310a5854affb6fa0.png" alt="" class="responsive-image" />
