<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/4c5d5b985db61796.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/4c5d5b985db61796.png" alt="" class="responsive-image" />

  <img src="/images/CDC/17b91b88dd394b9b.png" alt="" class="responsive-image" />

  <img src="/images/CDC/b87e3a6ec9827549.png" alt="" class="responsive-image" />

  <img src="/images/CDC/e1da0733a74a1d68.png" alt="" class="responsive-image" />
