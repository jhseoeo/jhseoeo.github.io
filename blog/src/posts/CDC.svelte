<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/6ea0adb54f8a0a70.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/6ea0adb54f8a0a70.png" alt="" class="responsive-image" />

  <img src="/images/CDC/60c6ffd1cef60876.png" alt="" class="responsive-image" />

  <img src="/images/CDC/63c4b3132359c674.png" alt="" class="responsive-image" />

  <img src="/images/CDC/0cadebe40fa35d56.png" alt="" class="responsive-image" />
