<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/902b757707707f81.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/902b757707707f81.png" alt="" class="responsive-image" />

  <img src="/images/CDC/23bad9d160186059.png" alt="" class="responsive-image" />

  <img src="/images/CDC/43b5ba65a1225f67.png" alt="" class="responsive-image" />

  <img src="/images/CDC/dc3b03a8e43dd044.png" alt="" class="responsive-image" />
