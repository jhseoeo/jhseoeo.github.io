<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/2ca307bcd55c9392.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/2ca307bcd55c9392.png" alt="" class="responsive-image" />

  <img src="/images/CDC/83f59f6ded021447.png" alt="" class="responsive-image" />

  <img src="/images/CDC/532bdc240fa5d84e.png" alt="" class="responsive-image" />

  <img src="/images/CDC/7b5490f4c98df4c0.png" alt="" class="responsive-image" />
