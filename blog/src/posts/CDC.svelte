<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/4b1a314312142a29.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/4b1a314312142a29.png" alt="" class="responsive-image" />

  <img src="/images/CDC/8662273147ceccf7.png" alt="" class="responsive-image" />

  <img src="/images/CDC/1d1a10949607b292.png" alt="" class="responsive-image" />

  <img src="/images/CDC/64289cb773e99715.png" alt="" class="responsive-image" />
