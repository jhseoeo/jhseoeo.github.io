<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/50be834de723aba2.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/50be834de723aba2.png" alt="" class="responsive-image" />

  <img src="/images/CDC/affaf1dea84b8465.png" alt="" class="responsive-image" />

  <img src="/images/CDC/990bebe2cb64ec68.png" alt="" class="responsive-image" />

  <img src="/images/CDC/c3f5d45dca79fff9.png" alt="" class="responsive-image" />
