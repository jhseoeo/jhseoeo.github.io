<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/1c72ca93fba98d24.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/1c72ca93fba98d24.png" alt="" class="responsive-image" />

  <img src="/images/CDC/237da6056451f1ad.png" alt="" class="responsive-image" />

  <img src="/images/CDC/7be1977ae939e4aa.png" alt="" class="responsive-image" />

  <img src="/images/CDC/640ed50b591866af.png" alt="" class="responsive-image" />
