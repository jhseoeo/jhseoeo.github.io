<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/029197747a97586a.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/029197747a97586a.png" alt="" class="responsive-image" />

  <img src="/images/CDC/bd67b20edebf58de.png" alt="" class="responsive-image" />

  <img src="/images/CDC/58fe7cefd99808e0.png" alt="" class="responsive-image" />

  <img src="/images/CDC/00346ccc8dc9e3a2.png" alt="" class="responsive-image" />
