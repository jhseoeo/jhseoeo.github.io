<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/af78b35c30c35564.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/af78b35c30c35564.png" alt="" class="responsive-image" />

  <img src="/images/CDC/d41b486c3c06def9.png" alt="" class="responsive-image" />

  <img src="/images/CDC/599a42cdd37e0364.png" alt="" class="responsive-image" />

  <img src="/images/CDC/64d495992f500930.png" alt="" class="responsive-image" />
