<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/f884db92cb4bb2a0.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/f884db92cb4bb2a0.png" alt="" class="responsive-image" />

  <img src="/images/CDC/2fcf2db190d24d51.png" alt="" class="responsive-image" />

  <img src="/images/CDC/34d29c9e21f00c6d.png" alt="" class="responsive-image" />

  <img src="/images/CDC/31213a6b73fc13e5.png" alt="" class="responsive-image" />
