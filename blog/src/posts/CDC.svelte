<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/596628b97462e318.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/596628b97462e318.png" alt="" class="responsive-image" />

  <img src="/images/CDC/58369a6e03c892df.png" alt="" class="responsive-image" />

  <img src="/images/CDC/40cc40b8faafd3df.png" alt="" class="responsive-image" />

  <img src="/images/CDC/637d578946ccebb8.png" alt="" class="responsive-image" />
