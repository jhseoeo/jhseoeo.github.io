<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/93820f2518de763c.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/93820f2518de763c.png" alt="" class="responsive-image" />

  <img src="/images/CDC/732222bd5d475171.png" alt="" class="responsive-image" />

  <img src="/images/CDC/19e26654effb591c.png" alt="" class="responsive-image" />

  <img src="/images/CDC/9bb8c70392ad224a.png" alt="" class="responsive-image" />
