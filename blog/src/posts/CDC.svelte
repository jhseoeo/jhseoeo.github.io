<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/aeaff532373cd86f.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/aeaff532373cd86f.png" alt="" class="responsive-image" />

  <img src="/images/CDC/91f8efb9a28f95ac.png" alt="" class="responsive-image" />

  <img src="/images/CDC/85a6f09e231ebc9f.png" alt="" class="responsive-image" />

  <img src="/images/CDC/502f30605e4a100e.png" alt="" class="responsive-image" />
