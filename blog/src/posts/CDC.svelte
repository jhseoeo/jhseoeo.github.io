<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/fd1dbc9f6649cd38.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/fd1dbc9f6649cd38.png" alt="" class="responsive-image" />

  <img src="/images/CDC/df133794f42d2d64.png" alt="" class="responsive-image" />

  <img src="/images/CDC/0e694d754573b4d1.png" alt="" class="responsive-image" />

  <img src="/images/CDC/0e1673a4e429919b.png" alt="" class="responsive-image" />
