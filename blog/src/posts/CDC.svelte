<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/fb7becfcf5dc0b37.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/fb7becfcf5dc0b37.png" alt="" class="responsive-image" />

  <img src="/images/CDC/571e7fb4b11662a1.png" alt="" class="responsive-image" />

  <img src="/images/CDC/252c3c0ae733b2f2.png" alt="" class="responsive-image" />

  <img src="/images/CDC/f87ee14e4f5c3f9b.png" alt="" class="responsive-image" />
