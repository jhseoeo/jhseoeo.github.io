<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/2b697a775b06dc80.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/2b697a775b06dc80.png" alt="" class="responsive-image" />

  <img src="/images/CDC/900ac3e3dd72fd14.png" alt="" class="responsive-image" />

  <img src="/images/CDC/4d8ba4c603862609.png" alt="" class="responsive-image" />

  <img src="/images/CDC/d59c739be19f0997.png" alt="" class="responsive-image" />
