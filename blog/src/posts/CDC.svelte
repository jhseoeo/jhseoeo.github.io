<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/9b68e35baaab7129.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/9b68e35baaab7129.png" alt="" class="responsive-image" />

  <img src="/images/CDC/00fb98b8c682ef8b.png" alt="" class="responsive-image" />

  <img src="/images/CDC/e77d2b884236e25e.png" alt="" class="responsive-image" />

  <img src="/images/CDC/ac43a0c8e31b28a2.png" alt="" class="responsive-image" />
