<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/dd4f3b0af1d9ce94.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/dd4f3b0af1d9ce94.png" alt="" class="responsive-image" />

  <img src="/images/CDC/a57db69bf368ddee.png" alt="" class="responsive-image" />

  <img src="/images/CDC/803dcf11e6add151.png" alt="" class="responsive-image" />

  <img src="/images/CDC/4ec3297389f948f9.png" alt="" class="responsive-image" />
