<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/284c8229dfd31ba9.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/284c8229dfd31ba9.png" alt="" class="responsive-image" />

  <img src="/images/CDC/085e80a006f50fcd.png" alt="" class="responsive-image" />

  <img src="/images/CDC/51b4387b35e81065.png" alt="" class="responsive-image" />

  <img src="/images/CDC/58d4c0297d32e5a9.png" alt="" class="responsive-image" />
