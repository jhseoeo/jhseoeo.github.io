<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/f1059daa16867159.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/f1059daa16867159.png" alt="" class="responsive-image" />

  <img src="/images/CDC/d1eaad8b67daf500.png" alt="" class="responsive-image" />

  <img src="/images/CDC/327e6234b720949d.png" alt="" class="responsive-image" />

  <img src="/images/CDC/0a3b63fc7ba130b6.png" alt="" class="responsive-image" />
