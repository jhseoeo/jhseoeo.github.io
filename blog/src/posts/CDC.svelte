<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/52020db3c92dbbcb.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/52020db3c92dbbcb.png" alt="" class="responsive-image" />

  <img src="/images/CDC/7554024d383b690c.png" alt="" class="responsive-image" />

  <img src="/images/CDC/70fe282588446abe.png" alt="" class="responsive-image" />

  <img src="/images/CDC/895a72a55450619e.png" alt="" class="responsive-image" />
