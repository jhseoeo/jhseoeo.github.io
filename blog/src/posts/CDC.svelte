<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/765d84c562403402.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/765d84c562403402.png" alt="" class="responsive-image" />

  <img src="/images/CDC/f0008e5997a5fa61.png" alt="" class="responsive-image" />

  <img src="/images/CDC/819da5b9176b06a3.png" alt="" class="responsive-image" />

  <img src="/images/CDC/fdc79a084fac4740.png" alt="" class="responsive-image" />
