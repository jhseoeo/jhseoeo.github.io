<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/6595469b2250dc37.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/6595469b2250dc37.png" alt="" class="responsive-image" />

  <img src="/images/CDC/dfc9fc687d0e1651.png" alt="" class="responsive-image" />

  <img src="/images/CDC/0658516b2121effb.png" alt="" class="responsive-image" />

  <img src="/images/CDC/5cf24f23f8ef3571.png" alt="" class="responsive-image" />
