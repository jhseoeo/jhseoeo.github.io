<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/e5b108462d604cdc.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/e5b108462d604cdc.png" alt="" class="responsive-image" />

  <img src="/images/CDC/25158e804f4078b8.png" alt="" class="responsive-image" />

  <img src="/images/CDC/d09c1f6f944b5a0c.png" alt="" class="responsive-image" />

  <img src="/images/CDC/668b65f5fd40b520.png" alt="" class="responsive-image" />
