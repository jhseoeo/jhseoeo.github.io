<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/49c0cbf08ae16875.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/49c0cbf08ae16875.png" alt="" class="responsive-image" />

  <img src="/images/CDC/bd05aa4eaab9ff06.png" alt="" class="responsive-image" />

  <img src="/images/CDC/35f9e66e6cb8193e.png" alt="" class="responsive-image" />

  <img src="/images/CDC/45cd5907bcb5ab59.png" alt="" class="responsive-image" />
