<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/486b380d74d4af3b.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/486b380d74d4af3b.png" alt="" class="responsive-image" />

  <img src="/images/CDC/c476ca12c032bfbf.png" alt="" class="responsive-image" />

  <img src="/images/CDC/aa92bc0bd300a885.png" alt="" class="responsive-image" />

  <img src="/images/CDC/82f1bd001c638db0.png" alt="" class="responsive-image" />
