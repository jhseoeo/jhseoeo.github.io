<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/a1c34891f89e965a.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/a1c34891f89e965a.png" alt="" class="responsive-image" />

  <img src="/images/CDC/7d2629add0078943.png" alt="" class="responsive-image" />

  <img src="/images/CDC/302876b1644a0911.png" alt="" class="responsive-image" />

  <img src="/images/CDC/352c616398222813.png" alt="" class="responsive-image" />
