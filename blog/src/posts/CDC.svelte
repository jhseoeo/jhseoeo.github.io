<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/f93960fc702113ea.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/f93960fc702113ea.png" alt="" class="responsive-image" />

  <img src="/images/CDC/104e68195f7aef84.png" alt="" class="responsive-image" />

  <img src="/images/CDC/be77e8d88c3870cd.png" alt="" class="responsive-image" />

  <img src="/images/CDC/e4d69581e0238d53.png" alt="" class="responsive-image" />
