<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/d8a2d18b9fe4ac2d.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/d8a2d18b9fe4ac2d.png" alt="" class="responsive-image" />

  <img src="/images/CDC/e181c9a0acbff423.png" alt="" class="responsive-image" />

  <img src="/images/CDC/920880fa639ae6ea.png" alt="" class="responsive-image" />

  <img src="/images/CDC/2404cc0de25f050f.png" alt="" class="responsive-image" />
