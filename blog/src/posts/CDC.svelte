<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/c8f2fa48bb670ef3.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/c8f2fa48bb670ef3.png" alt="" class="responsive-image" />

  <img src="/images/CDC/d4e8b116147e1fac.png" alt="" class="responsive-image" />

  <img src="/images/CDC/4366c517783a1096.png" alt="" class="responsive-image" />

  <img src="/images/CDC/830ca8915c9b8e31.png" alt="" class="responsive-image" />
