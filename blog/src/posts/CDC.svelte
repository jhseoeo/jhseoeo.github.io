<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/faadcd66d9e08778.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/faadcd66d9e08778.png" alt="" class="responsive-image" />

  <img src="/images/CDC/f87adab02f6dd651.png" alt="" class="responsive-image" />

  <img src="/images/CDC/63a99cd461ae3bb9.png" alt="" class="responsive-image" />

  <img src="/images/CDC/5904943483cf02f6.png" alt="" class="responsive-image" />
