<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/17da5cfdf50a6185.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/17da5cfdf50a6185.png" alt="" class="responsive-image" />

  <img src="/images/CDC/84a3477bf30f90ab.png" alt="" class="responsive-image" />

  <img src="/images/CDC/681d88b89c169634.png" alt="" class="responsive-image" />

  <img src="/images/CDC/0ae414ec2271a034.png" alt="" class="responsive-image" />
