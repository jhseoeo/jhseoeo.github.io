<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/2d5ce5c0de25c0fd.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/2d5ce5c0de25c0fd.png" alt="" class="responsive-image" />

  <img src="/images/CDC/729b37d808454994.png" alt="" class="responsive-image" />

  <img src="/images/CDC/91368edadc318c78.png" alt="" class="responsive-image" />

  <img src="/images/CDC/b8ab755e0ada338c.png" alt="" class="responsive-image" />
