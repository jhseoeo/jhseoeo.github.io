<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/529cdf2d4c5675ca.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/529cdf2d4c5675ca.png" alt="" class="responsive-image" />

  <img src="/images/CDC/20601b886c0db496.png" alt="" class="responsive-image" />

  <img src="/images/CDC/0863bcd4e040bf31.png" alt="" class="responsive-image" />

  <img src="/images/CDC/180ffdc9e081215b.png" alt="" class="responsive-image" />
