<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/bdf0ff365a33c1b7.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/bdf0ff365a33c1b7.png" alt="" class="responsive-image" />

  <img src="/images/CDC/a4ed466aa8a44071.png" alt="" class="responsive-image" />

  <img src="/images/CDC/33749fb8cfb1ad4f.png" alt="" class="responsive-image" />

  <img src="/images/CDC/f8a3ca371db3f1eb.png" alt="" class="responsive-image" />
