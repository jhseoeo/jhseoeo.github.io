<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/d4223a56f2eaa192.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/d4223a56f2eaa192.png" alt="" class="responsive-image" />

  <img src="/images/CDC/37ee81b72300bf0b.png" alt="" class="responsive-image" />

  <img src="/images/CDC/0e2e3d2e96a3bdf8.png" alt="" class="responsive-image" />

  <img src="/images/CDC/88bde771e11bacff.png" alt="" class="responsive-image" />
