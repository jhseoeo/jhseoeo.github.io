<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/7ae80837f5fa8ebe.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/7ae80837f5fa8ebe.png" alt="" class="responsive-image" />

  <img src="/images/CDC/966a78a1292d5a5e.png" alt="" class="responsive-image" />

  <img src="/images/CDC/743afa801dc3e775.png" alt="" class="responsive-image" />

  <img src="/images/CDC/f1de465cd683610b.png" alt="" class="responsive-image" />
