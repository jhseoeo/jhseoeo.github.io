<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/60d2455a36c253be.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/60d2455a36c253be.png" alt="" class="responsive-image" />

  <img src="/images/CDC/6a069913db43dc1f.png" alt="" class="responsive-image" />

  <img src="/images/CDC/1c0a4b62fb22cafa.png" alt="" class="responsive-image" />

  <img src="/images/CDC/58d0a6c60ce728d1.png" alt="" class="responsive-image" />
