<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/c9613b3377246e20.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/c9613b3377246e20.png" alt="" class="responsive-image" />

  <img src="/images/CDC/58f65ee9ac0d0991.png" alt="" class="responsive-image" />

  <img src="/images/CDC/decaa8bd8459c042.png" alt="" class="responsive-image" />

  <img src="/images/CDC/6203afa414ba896c.png" alt="" class="responsive-image" />
