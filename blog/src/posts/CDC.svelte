<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/6d7e6c8705a78a92.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/6d7e6c8705a78a92.png" alt="" class="responsive-image" />

  <img src="/images/CDC/6a4a5019e99d4d83.png" alt="" class="responsive-image" />

  <img src="/images/CDC/86be44930d16e00b.png" alt="" class="responsive-image" />

  <img src="/images/CDC/0c1174d956cd2fb9.png" alt="" class="responsive-image" />
