<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/a030916a46a7a84e.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/a030916a46a7a84e.png" alt="" class="responsive-image" />

  <img src="/images/CDC/cbdb6adacf798cde.png" alt="" class="responsive-image" />

  <img src="/images/CDC/c8bbc137dd447485.png" alt="" class="responsive-image" />

  <img src="/images/CDC/04410fcf23b745d5.png" alt="" class="responsive-image" />
