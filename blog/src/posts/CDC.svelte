<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/170cff0f661a5463.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/170cff0f661a5463.png" alt="" class="responsive-image" />

  <img src="/images/CDC/60a3e7f67ef16139.png" alt="" class="responsive-image" />

  <img src="/images/CDC/04893f5cf44e8523.png" alt="" class="responsive-image" />

  <img src="/images/CDC/8851a8d41e1d8c47.png" alt="" class="responsive-image" />
