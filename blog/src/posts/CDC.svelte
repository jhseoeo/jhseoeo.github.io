<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/52fc0f9e73fc1609.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/52fc0f9e73fc1609.png" alt="" class="responsive-image" />

  <img src="/images/CDC/d519df168a542ae6.png" alt="" class="responsive-image" />

  <img src="/images/CDC/c041717ce0435182.png" alt="" class="responsive-image" />

  <img src="/images/CDC/48d51ba47856ef9b.png" alt="" class="responsive-image" />
