<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/50c3df719c23d8f2.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/50c3df719c23d8f2.png" alt="" class="responsive-image" />

  <img src="/images/CDC/4c48c2b4105ccd87.png" alt="" class="responsive-image" />

  <img src="/images/CDC/343c8fd241a39fe3.png" alt="" class="responsive-image" />

  <img src="/images/CDC/144f9beabe5e338b.png" alt="" class="responsive-image" />
