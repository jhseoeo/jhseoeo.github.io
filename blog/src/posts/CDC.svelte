<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/116f35c6149a7659.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/116f35c6149a7659.png" alt="" class="responsive-image" />

  <img src="/images/CDC/27c4ce2b99251c6f.png" alt="" class="responsive-image" />

  <img src="/images/CDC/286ea32e03d57727.png" alt="" class="responsive-image" />

  <img src="/images/CDC/dd75254ebaeb760a.png" alt="" class="responsive-image" />
