<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/17ad3bd88061dfc7.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/17ad3bd88061dfc7.png" alt="" class="responsive-image" />

  <img src="/images/CDC/eba19d2a2f763e43.png" alt="" class="responsive-image" />

  <img src="/images/CDC/9d156b00a00c7c59.png" alt="" class="responsive-image" />

  <img src="/images/CDC/51ed2abc95aba5cf.png" alt="" class="responsive-image" />
