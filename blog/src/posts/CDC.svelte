<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/7e5a23418a652afb.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/7e5a23418a652afb.png" alt="" class="responsive-image" />

  <img src="/images/CDC/d086324d3a4dc3ca.png" alt="" class="responsive-image" />

  <img src="/images/CDC/406a6a577dcc2670.png" alt="" class="responsive-image" />

  <img src="/images/CDC/67a3786596078edd.png" alt="" class="responsive-image" />
