<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/ce985eb946424688.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/ce985eb946424688.png" alt="" class="responsive-image" />

  <img src="/images/CDC/92d66648744ec5a2.png" alt="" class="responsive-image" />

  <img src="/images/CDC/9e68147fdbb62b6f.png" alt="" class="responsive-image" />

  <img src="/images/CDC/5830e263fa3763bc.png" alt="" class="responsive-image" />
