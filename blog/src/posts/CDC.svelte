<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/6da083ab028b34aa.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/6da083ab028b34aa.png" alt="" class="responsive-image" />

  <img src="/images/CDC/e258dba14bc3af81.png" alt="" class="responsive-image" />

  <img src="/images/CDC/c352f01cc7834a39.png" alt="" class="responsive-image" />

  <img src="/images/CDC/87aa7a79ab3e9c45.png" alt="" class="responsive-image" />
