<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/ac533557d7407681.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/ac533557d7407681.png" alt="" class="responsive-image" />

  <img src="/images/CDC/33a566ef9084f14e.png" alt="" class="responsive-image" />

  <img src="/images/CDC/ddc5181944fd4bcd.png" alt="" class="responsive-image" />

  <img src="/images/CDC/224d5e84d1753592.png" alt="" class="responsive-image" />
