<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/28ee75951eeaba65.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/28ee75951eeaba65.png" alt="" class="responsive-image" />

  <img src="/images/CDC/721d4d26580a3c2a.png" alt="" class="responsive-image" />

  <img src="/images/CDC/f4456089af6edbdf.png" alt="" class="responsive-image" />

  <img src="/images/CDC/c75d46047a265ab4.png" alt="" class="responsive-image" />
