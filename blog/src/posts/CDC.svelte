<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/5fee36b933a88758.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/5fee36b933a88758.png" alt="" class="responsive-image" />

  <img src="/images/CDC/59611dc27a0b815f.png" alt="" class="responsive-image" />

  <img src="/images/CDC/3986cb69beb46e49.png" alt="" class="responsive-image" />

  <img src="/images/CDC/10cf1d719fc2e978.png" alt="" class="responsive-image" />
