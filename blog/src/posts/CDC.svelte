<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/bf6bc69cbccaae64.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/bf6bc69cbccaae64.png" alt="" class="responsive-image" />

  <img src="/images/CDC/620fb7d945d2b02d.png" alt="" class="responsive-image" />

  <img src="/images/CDC/7a53ab59d11d9281.png" alt="" class="responsive-image" />

  <img src="/images/CDC/35d2be01a2ef3875.png" alt="" class="responsive-image" />
