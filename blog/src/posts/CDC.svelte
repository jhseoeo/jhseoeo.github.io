<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/48ce1b3bc0fb0a17.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/48ce1b3bc0fb0a17.png" alt="" class="responsive-image" />

  <img src="/images/CDC/010345ca41515ea0.png" alt="" class="responsive-image" />

  <img src="/images/CDC/61cefe2b3d175ff0.png" alt="" class="responsive-image" />

  <img src="/images/CDC/778b80beb6b8cf87.png" alt="" class="responsive-image" />
