<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/7698fa15213018e0.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/7698fa15213018e0.png" alt="" class="responsive-image" />

  <img src="/images/CDC/131bac08b7f78c20.png" alt="" class="responsive-image" />

  <img src="/images/CDC/fc7d443a55eeea9b.png" alt="" class="responsive-image" />

  <img src="/images/CDC/a9092e014405e3b0.png" alt="" class="responsive-image" />
