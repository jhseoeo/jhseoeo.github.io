<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/e5a546952a3f91b3.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/e5a546952a3f91b3.png" alt="" class="responsive-image" />

  <img src="/images/CDC/282277e8fa6edd41.png" alt="" class="responsive-image" />

  <img src="/images/CDC/553d745c205f9d1d.png" alt="" class="responsive-image" />

  <img src="/images/CDC/712f0c722021b58b.png" alt="" class="responsive-image" />
