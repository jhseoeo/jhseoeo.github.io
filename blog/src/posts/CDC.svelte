<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/bfa3d4d199c370e2.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/bfa3d4d199c370e2.png" alt="" class="responsive-image" />

  <img src="/images/CDC/2c3f9c536d24d4fe.png" alt="" class="responsive-image" />

  <img src="/images/CDC/eb8d9ff9556d5633.png" alt="" class="responsive-image" />

  <img src="/images/CDC/8ffa12eb7d9cca13.png" alt="" class="responsive-image" />
