<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/47f3675e7a16d091.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/47f3675e7a16d091.png" alt="" class="responsive-image" />

  <img src="/images/CDC/0337fab257310118.png" alt="" class="responsive-image" />

  <img src="/images/CDC/7d3735f715539d5b.png" alt="" class="responsive-image" />

  <img src="/images/CDC/696b9843b962ab33.png" alt="" class="responsive-image" />
