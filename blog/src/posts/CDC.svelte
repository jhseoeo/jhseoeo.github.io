<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/3bbc3f621d16f573.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/3bbc3f621d16f573.png" alt="" class="responsive-image" />

  <img src="/images/CDC/c8583385d03debbb.png" alt="" class="responsive-image" />

  <img src="/images/CDC/2e20b0e572d7b66b.png" alt="" class="responsive-image" />

  <img src="/images/CDC/b62458433fb0f0a3.png" alt="" class="responsive-image" />
