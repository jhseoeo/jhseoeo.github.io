<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/7c7ec948e71c7fdf.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/7c7ec948e71c7fdf.png" alt="" class="responsive-image" />

  <img src="/images/CDC/af45323905634fb9.png" alt="" class="responsive-image" />

  <img src="/images/CDC/b339b4b4c5487a8a.png" alt="" class="responsive-image" />

  <img src="/images/CDC/6e7e293c234099b8.png" alt="" class="responsive-image" />
