<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/775caddec7286aad.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/775caddec7286aad.png" alt="" class="responsive-image" />

  <img src="/images/CDC/cc442e079689e066.png" alt="" class="responsive-image" />

  <img src="/images/CDC/df707095b0eb72d8.png" alt="" class="responsive-image" />

  <img src="/images/CDC/c6ff0cd53320d176.png" alt="" class="responsive-image" />
