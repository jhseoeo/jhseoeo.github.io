<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/2cd5de8e2ab4cfa9.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/2cd5de8e2ab4cfa9.png" alt="" class="responsive-image" />

  <img src="/images/CDC/09bc317fb82dd16f.png" alt="" class="responsive-image" />

  <img src="/images/CDC/9c7436faf70b5246.png" alt="" class="responsive-image" />

  <img src="/images/CDC/32e86f7eb828c6b3.png" alt="" class="responsive-image" />
