<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/d98acaaff8833281.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/d98acaaff8833281.png" alt="" class="responsive-image" />

  <img src="/images/CDC/da0431c1807e19f7.png" alt="" class="responsive-image" />

  <img src="/images/CDC/ae64e385a439004d.png" alt="" class="responsive-image" />

  <img src="/images/CDC/f1bcb81c1605a1ba.png" alt="" class="responsive-image" />
