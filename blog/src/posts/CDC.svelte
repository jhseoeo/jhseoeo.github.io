<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/c78ad6d313cc1a67.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/c78ad6d313cc1a67.png" alt="" class="responsive-image" />

  <img src="/images/CDC/ce2a6ba440192919.png" alt="" class="responsive-image" />

  <img src="/images/CDC/04b264f1eefe14ca.png" alt="" class="responsive-image" />

  <img src="/images/CDC/4bfd74cac7c19296.png" alt="" class="responsive-image" />
