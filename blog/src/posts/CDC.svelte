<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/8ce0a7c2193a4c21.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/8ce0a7c2193a4c21.png" alt="" class="responsive-image" />

  <img src="/images/CDC/e91cac7308dfdeb1.png" alt="" class="responsive-image" />

  <img src="/images/CDC/8699d981c4057657.png" alt="" class="responsive-image" />

  <img src="/images/CDC/5a82751f43b6cb6b.png" alt="" class="responsive-image" />
