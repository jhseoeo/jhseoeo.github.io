<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/87174856a3b57077.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/87174856a3b57077.png" alt="" class="responsive-image" />

  <img src="/images/CDC/3e4e86f89d68b2b8.png" alt="" class="responsive-image" />

  <img src="/images/CDC/daf565490c7c8a37.png" alt="" class="responsive-image" />

  <img src="/images/CDC/16330cc3055201a8.png" alt="" class="responsive-image" />
