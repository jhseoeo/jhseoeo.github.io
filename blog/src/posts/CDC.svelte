<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/e1b3eb743c1ce2e7.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/e1b3eb743c1ce2e7.png" alt="" class="responsive-image" />

  <img src="/images/CDC/808def105254ce48.png" alt="" class="responsive-image" />

  <img src="/images/CDC/1fd99cfc4f8fa77e.png" alt="" class="responsive-image" />

  <img src="/images/CDC/98f8c59abc9b4a79.png" alt="" class="responsive-image" />
