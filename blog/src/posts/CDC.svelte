<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/d0962cd0ff982156.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/d0962cd0ff982156.png" alt="" class="responsive-image" />

  <img src="/images/CDC/c86490cc88b922ad.png" alt="" class="responsive-image" />

  <img src="/images/CDC/55da1c4607551c09.png" alt="" class="responsive-image" />

  <img src="/images/CDC/6bc7dc39360485a9.png" alt="" class="responsive-image" />
