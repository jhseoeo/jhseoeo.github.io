<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/c4b34c81411692c8.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/c4b34c81411692c8.png" alt="" class="responsive-image" />

  <img src="/images/CDC/0e281e27a916fc1c.png" alt="" class="responsive-image" />

  <img src="/images/CDC/6cd2bdfd99d360d5.png" alt="" class="responsive-image" />

  <img src="/images/CDC/d2cc6cbe4bda1042.png" alt="" class="responsive-image" />
