<script context="module" lang="ts">
  export const metadata = {
    ...
    coverImage: '/images/CDC/f2f8becf7db9efe5.png',
    coverWidth: 16,
    coverHeight: 9,
    excerpt: '',
    indexed: false,
...
<li>대략 <a href="https://debezium.io/documentation/reference/2.7/tutorial.html#starting-zookeeper">튜토리얼</a> 따라서 열심히 쿼리를 날려보면
  <img src="/images/CDC/f2f8becf7db9efe5.png" alt="" class="responsive-image" />

  <img src="/images/CDC/b238d645400d3f4b.png" alt="" class="responsive-image" />

  <img src="/images/CDC/6c4110ba92b0c2ee.png" alt="" class="responsive-image" />

  <img src="/images/CDC/e5f5dd366dc49faa.png" alt="" class="responsive-image" />
