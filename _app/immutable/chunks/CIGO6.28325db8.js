import{S as vt,i as ht,s as Pt,k as o,q as i,a as k,y as v,l as e,m as l,h as s,r as f,c as r,z as h,n as w,U as Ct,b as t,E as c,A as P,g as C,d as R,B as T,M as X}from"./index.d78780bf.js";import{H as Rt}from"./Highlight.1019e7a6.js";import{C as V}from"./CodeBlockWrapper.9fa2b505.js";function Tt($){let p;return{c(){p=i("에러를 무시해서는 안 된다")},l(y){p=f(y,"에러를 무시해서는 안 된다")},m(y,u){t(y,p,u)},d(y){y&&s(p)}}}function Ht($){let p,y=`<code class="language-go"><span class="token keyword">type</span> Result1 <span class="token keyword">struct</span> <span class="token punctuation">&#123;</span>
    Result ResultType1
    Error err
