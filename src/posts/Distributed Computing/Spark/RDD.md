...
- Spark를 쓰면 오페레이터는 log의 에러 메시지를 RAM으로 불러와서, interactively(대화식) query를 날릴 수 있다.  
  ![Alt text](/post_img/Distributed%20Computing/Spark/RDD/2.png)
...
![Alt text](/post_img/Distributed%20Computing/Spark/RDD/3.png)

사용자는 이렇게 얻은 RDD에서 추가적인 transformation을 실행하고, 그렇게 또 얻은 RDD에서 결과를 얻을 수 있음  
![Alt text](/post_img/Distributed%20Computing/Spark/RDD/1.png)
...
![Alt text](/post_img/Distributed%20Computing/Spark/RDD/0.png)
...
![Alt text](/post_img/Distributed%20Computing/Spark/RDD/4.png)
...
![Alt text](/post_img/Distributed%20Computing/Spark/RDD/5.png)  
...
![Alt text](/post_img/Distributed%20Computing/Spark/RDD/6.png) ![Alt text](/post_img/Distributed%20Computing/Spark/RDD/7.png)
...
![Alt text](/post_img/Distributed%20Computing/Spark/RDD/8.png) ![Alt text](/post_img/Distributed%20Computing/Spark/RDD/9.png)  
...
- 아래와 같이, links를 정의할 때 PartitionBy()라는 method를 통해 진행  
  ![Alt text](/post_img/Distributed%20Computing/Spark/RDD/10.png)
...
4. partitioning scheme 및 데이터 배치에 대한 메타데이터
   - 해당 인터페이스는 아래와 같은 테이블에서 보여줌  
     ![Alt text](/post_img/Distributed%20Computing/Spark/RDD/11.png)
...
![Alt text](/post_img/Distributed%20Computing/Spark/RDD/12.png)
...
![Alt text](/post_img/Distributed%20Computing/Spark/RDD/13.png)  
...
![Alt text](/post_img/Distributed%20Computing/Spark/RDD/14.png)  
...
![Alt text](/post_img/Distributed%20Computing/Spark/RDD/15.png) ![Alt text](/post_img/Distributed%20Computing/Spark/RDD/16.png)
...
![Alt text](/post_img/Distributed%20Computing/Spark/RDD/17.png)  
...
![Alt text](/post_img/Distributed%20Computing/Spark/RDD/18.png)  
...
![Alt text](/post_img/Distributed%20Computing/Spark/RDD/19.png)  
...
![Alt text](/post_img/Distributed%20Computing/Spark/RDD/20.png)  
...
![Alt text](/post_img/Distributed%20Computing/Spark/RDD/21.png)
...
![Alt text](/post_img/Distributed%20Computing/Spark/RDD/22.png)  
